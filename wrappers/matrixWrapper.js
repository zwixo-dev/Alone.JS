...
function product(arr) {
  ...
  const product = matrix.product(arr.length, pointer);
...
function average(arr) {
  ...
  const average = matrix.average(arr.length, pointer);
...
function min(arr) {
  ...
  const min = matrix.min(arr.length, pointer);
...
function range(arr) {
  ...
  const range = matrix.range(arr.length, pointer);
