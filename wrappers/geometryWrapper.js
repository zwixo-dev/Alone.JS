...
Module.onRuntimeInitialized = () => {
    ...
    geometry = {
        ...
        geometry_midpoint_y: Module.cwrap("geometry_midpoint_y", "number", ["number"]),
        ...
        circle_diameter: Module.cwrap("circle_diameter", "number", ["number"]),
        ...
        cube_space_diagonal: Module.cwrap("cube_space_diagonal", "number", ["number"]),
        ...
        cuboid_space_diagonal: Module.cwrap("cuboid_space_diagonal", "number", ["number", "number", "number"]),
        ...
        sphere_surface_area: Module.cwrap("sphere_surface_area", "number", ["number"]),
...
function cuboid_space_diagonal(length, width, height){
    return geometry.cuboid_space_diagonal(length, width, height);
}
...
function cylinder_surface_area(radius, height){
    return geometry.cylinder_surface_area(radius, height);
}
// double cylinder_lateral_area(double radius, double height);
// cylinder_lateral_area
function cylinder_lateral_area(radius, height){
    return geometry.cylinder_lateral_area(radius, height);
}
