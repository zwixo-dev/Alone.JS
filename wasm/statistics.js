...
function findWasmBinary() {
  return locateFile('statistics.wasm');
}
...
var _array_correlation = Module['_array_correlation'] = makeInvalidEarlyAccess('_array_correlation');
var _array_zscore = Module['_array_zscore'] = makeInvalidEarlyAccess('_array_zscore');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['array_correlation'] != 'undefined', 'missing Wasm export: array_correlation');
  assert(typeof wasmExports['array_zscore'] != 'undefined', 'missing Wasm export: array_zscore');
  ...
  _array_variance = Module['_array_variance'] = createExportWrapper('array_variance', 3);
  _array_stddev = Module['_array_stddev'] = createExportWrapper('array_stddev', 3);
  ...
  _array_skewness = Module['_array_skewness'] = createExportWrapper('array_skewness', 3);
  _array_kurtosis = Module['_array_kurtosis'] = createExportWrapper('array_kurtosis', 3);
  _array_covariance = Module['_array_covariance'] = createExportWrapper('array_covariance', 4);
  _array_normalize = Module['_array_normalize'] = createExportWrapper('array_normalize', 3);
  _array_correlation = Module['_array_correlation'] = createExportWrapper('array_correlation', 4);
  _array_zscore = Module['_array_zscore'] = createExportWrapper('array_zscore', 3);
